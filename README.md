...
#### Класс Header
Наследует класс `Component`.Отвечает за отображение иконки корзины со счетчиком количества товаров в ней

#### Класс Gallery
Наследует класс `Component`.Отвечает за отображение списка (галереи) товаров на главной странице сайта
...
- Поля класса
    ...
    - `modalContent: HTMLElement` - контейнер для отображения контента внутри модального окна в соответствии с выбранным шаблоном
...
#### Класс OrderSuccess
Отвечает за отображение информации в модальном окне после успешного оформления заказа

#### Класс Product
Базовый класс

#### Класс CardCatalog
Отвечает за отображение одного элемента в каталоге (галерее) товаров на главной странице

#### Класс CardFull
Отвечает за отображение в модальном окне полной информации о конкретном товаре.

#### Класс CardCompact
Отвечает за отображение основной краткой  информации о выбранном товаре в корзине
